...
The extension maintains a per-domain whitelist. Eighteen web applications are pre-protected out of the box: Google Docs, Google Sheets, Google Slides, Gmail, Google Drive, Google Calendar, Notion, Figma, Linear, Miro, Canva, Lucid, Airtable, Asana, Monday, Slack, Discord, and Microsoft Teams. Users can add any domain to the whitelist from the popup. Whitelisted tabs are never suspended regardless of idle time.
